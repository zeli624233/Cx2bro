...
rc /nologo /fo"%OUT%\AppIcon.res" "%SRC%\AppIcon.rc"

echo Compiling...
cl /nologo /O2 /MT /W3 /EHsc /DUNICODE /D_UNICODE /utf-8 /Fo"%OUT%\\" /Fe"%TARGET%" %SOURCES% "%OUT%\AppIcon.res" /link shell32.lib comctl32.lib comdlg32.lib user32.lib kernel32.lib gdi32.lib advapi32.lib
